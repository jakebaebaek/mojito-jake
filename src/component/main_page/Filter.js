...
function Filter() {
  ...
  // let booziness3 = emoji.filter((item) => item["value"].includes("booziness3"))[0].url
  // let booziness5 = emoji.filter((item) => item["value"].includes("booziness5"))[0].url
 
  // let sweetness1 = emoji.filter((item) => item["value"].includes("sweetness1"))[0].url
  // let sweetness3 = emoji.filter((item) => item["name"].includes("Wine Glass"))[0].url
  // let sweetness5 = emoji.filter((item) => item["value"].includes("sweetness5"))[0].url
